...
builtins! {
    ...
    //     },
    // ))))))
    // "any <?>" ; Any1(_0: Box<NixLambda>) => |param: Gc<Tree>, lambda: &NixLambda| {
    //     let list = match param.eval()?.borrow() {
    //         NixValue::List(ref x) => x.clone(),
    //         _ => panic!(),
    //     };
    ...
    //     Ok(Gc::new(NixValue::Bool(false)))
    // }
    // //         NixBuiltin::All => NixValue::Lambda(NixLambda::Builtin(NixBuiltin::All1(Box::new(
    // //             match param.to_value() {
    // //                 NixValue::Lambda(ref x) => x.clone(),
    // //                 _ => panic!(),
    // //             },
    // //         )))),
    // //         NixBuiltin::All1(lambda) => {
    // //             let list = match param.to_value() {
    // //                 NixValue::List(ref x) => x.clone(),
    // //                 _ => panic!(),
    // //             };
    // //             for item in list {
    // //                 let condition = match eval_lambda(*lambda.clone(), item.clone()) {
    // //                     NixValue::Bool(x) => x,
    // //                     _ => panic!(),
    // //                 };
    // //                 if !condition {
    // //                     return NixValue::Bool(false);
    // //                 }
    // //             }
    // //             NixValue::Bool(true)
    // //         }
    // //         NixBuiltin::AttrNames => match param.to_value() {
    // //             NixValue::Map(ref x) => NixValue::List(
    // //                 scope_borrow(x)
    // //                     .keys()
    // //                     .map(|x| LazyNixValue::Concrete(NixValue::Str(x.clone())))
    // //                     .collect(),
    // //             ),
    // //             _ => panic!(),
    // //         },
    // //         NixBuiltin::AttrValues => match param.to_value() {
    // //             NixValue::Map(ref x) => {
    // //                 NixValue::List(scope_borrow(x).values().map(|x| x.clone()).collect())
    // //             }
    // //             _ => panic!(),
    // //         },

    // //         NixBuiltin::ReplaceStrings => NixValue::Lambda(NixLambda::Builtin(
    // //             NixBuiltin::ReplaceStrings1(Box::new(param)),
    // //         )),
    // //         NixBuiltin::ReplaceStrings1(a) => NixValue::Lambda(NixLambda::Builtin(
    // //             NixBuiltin::ReplaceStrings2(a.clone(), Box::new(param)),
    // //         )),
    // //         NixBuiltin::ReplaceStrings2(from, to) => {
    // //             let from = match from.clone().to_value() {
    // //                 NixValue::List(ref x) => x
    // //                     .clone()
    // //                     .into_iter()
    ...
    // //                 _ => panic!(),
    // //             };
    // //             let to = match to.clone().to_value() {
    // //                 NixValue::List(ref x) => x
    // //                     .clone()
    // //                     .into_iter()
    // //                     .map(|x| match x.to_value() {
    ...
    // //                 _ => panic!(),
    // //             };
    // //             let mut param = match param.to_value() {
    // //                 NixValue::Str(ref x) => x.clone(),
    // //                 _ => panic!(),
    // //             };
    // //             // param.matches(pat)
    ...
    // //             todo!()
    // //             // for i in 0..from.len() {
    // //             //     param = param.replace(&from[i], &to[i]);
    // //             // }
